...
export default function Home() {
  return (
    <main className="min-h-screen w-full">
      <header
        className={`w-full h-screen items-center justify-center  flex flex-col bg-[url(../src/assets/img/background/6B99E25D-CE04-4971-B271-2EA71408B544.jpg)]  bg-cover bg-center md:bg-fixed`}
      >
        ...
        <a
          href="#"
          className="bg-winter-600 text-xl z-10 px-4 py-3 hover:shadow-2xl hover:shadow-winter-200 transition-all rounded-md flex items-center justify-center font-cinzel font-medium tracking-wider text-winter-700 mt-10"
        >
          EXPLORAR
        </a>
      </header>
      ...
      <section
        className={`w-full h-screen  flex bg-[url(../src/assets/img/background/DACA1378-472C-48FE-B0C2-EC65639013D3.jpg)] bg-cover bg-center  md:bg-fixed`}
      >
        <div className="absolute w-full h-screen bg-black bg-opacity-50 bg-fixed"></div>
        <div className="z-10 w-full md:w-1/2  p-20  ">
          <div className="w-full h-fit flex flex-col gap-10 border border-winter-400 p-10">
      ...
      <section
        className={`w-full h-screen  flex bg-[url(../src/assets/img/background/8DCE109A-2ECB-486B-9248-EED37BEB3469.jpg)] bg-cover bg-center md:bg-fixed`}
      >
        <div className="absolute w-full h-screen bg-black bg-opacity-50 bg-fixed"></div>
      ...
      <section
        className={`w-full h-screen  md:h-screen  flex bg-[url(../src/assets/img/background/_DSC0445.JPG)] bg-cover bg-center  md:bg-fixed`}
      >
        <div className="absolute w-full h-screen bg-black bg-opacity-50 bg-fixed"></div>
        <div className="p-20 gap-10 flex flex-col items-center justify-center z-20">
          <p className="font-cinzel text-winter-400 text-md md:text-3xl text-center tracking-wider leading-relaxed ">
      ...
      <section
        className={`w-full h-screen  flex bg-[url(../src/assets/img/background/7FD1FBD9-BC6E-4ADA-B80B-33CB62F47775.jpg)]  bg-cover bg-center  md:bg-fixed`}
      >
        <div className="absolute w-full h-screen bg-black bg-opacity-50 bg-fixed"></div>
        <div className="p-20 gap-10 flex flex-col items-center justify-center z-20">
          <p className="font-cinzel text-winter-400 text-md md:text-3xl text-center tracking-wider leading-relaxed ">
      ...
      <footer className="w-full h-auto bg-gray-900 flex flex-col items-center md:items-start md:flex-row justify-evenly">
        ...
        <div className="max-w-full md:p-5  flex flex-col items-center justify-normal gap-3">
          <h3 className="font-primary text-winter-200 text-xl">
            DEJAME TU MENSAJE
          </h3>
